...
<body>
	...
	<div class="comm">
		<div class="box box2">
			<div class="command">
				<div>
					<?php echo $_SESSION['p1']->_nom; ?>
				</div>
				<div>
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
width="24" height="24"
viewBox="0 0 224 224"
style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,224v-224h224v224z" fill="none"></path><g fill="#add8e6"><path d="M154,28c-27.02,0 -42,19.50667 -42,19.50667c0,0 -14.98,-19.50667 -42,-19.50667c-28.35467,0 -51.33333,22.97867 -51.33333,51.33333c0,38.92933 45.84533,76.65467 58.62267,88.57333c14.71867,13.72 34.71067,31.36 34.71067,31.36c0,0 19.992,-17.64 34.71067,-31.36c12.77733,-11.91867 58.62267,-49.644 58.62267,-88.57333c0,-28.35467 -22.97867,-51.33333 -51.33333,-51.33333z"></path></g></g></svg><br />
					<?php echo $_SESSION['p1']->_bouclier; ?>
				</div>
				<div>
